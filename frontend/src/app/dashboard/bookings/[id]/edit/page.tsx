...
export default function EditBookingPage() {
  ...
  const fetchData = async () => {
    ...
    try {
      const [bookingResponse, propertiesResponse, guestsResponse] = await Promise.all([
      ...
      if (bookingResponse.status === 401 || propertiesResponse.status === 401 || guestsResponse.status === 401) {
      ...
      if (bookingResponse.ok && propertiesResponse.ok && guestsResponse.ok) {
        const [bookingData, propertiesData, guestsData] = await Promise.all([
        ...
        setFormData({
          ...
          booking_source: bookingData.booking_source || 'whatsapp',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4 sm:py-6">
            <div className="flex items-center min-w-0 flex-1">
              ...
              <h1 className="text-xl sm:text-3xl font-bold text-gray-900">Edit Booking</h1>
            </div>
          </div>
        </div>
      </header>
