      ...
      try {
        ...
        if (response.ok) {
          ...
          setFormData({
            ...
            price_per_night: property.price_per_night ? property.price_per_night.toString() : '',
        ...
        alert('Network error while loading property');
        router.push('/dashboard/properties');
      } finally {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        alert('Failed to update property: ' + (errorData.detail || 'Unknown error'));
      }
    } catch (error) {
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <div className="text-lg text-gray-600">Loading property data...</div>
        </div>
      </div>
    );
  }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4 sm:py-6">
            <div className="flex items-center">
              ...
              <h1 className="text-xl sm:text-3xl font-bold text-gray-900">Edit Property</h1>
            </div>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-2xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        <div className="card">
          <div className="px-6 py-4 border-b border-gray-200">
            ...
            <p className="text-sm text-gray-600">Update details about your guesthouse property.</p>
          </div>
